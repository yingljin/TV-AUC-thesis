...
1. Abnormal value of true AUC at a single specific point
- actually, it's a abnormaly specificity at specific time and $\eta$ value

2. Estimating survival function and density for concordance
